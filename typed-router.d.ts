...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    '/2.3.2-store-getters/': RouteRecordInfo<'/2.3.2-store-getters/', '/2/3/2-store-getters', Record<never, never>, Record<never, never>>,
    '/2.3.2-store-getters/Test': RouteRecordInfo<'/2.3.2-store-getters/Test', '/2/3/2-store-getters/Test', Record<never, never>, Record<never, never>>,
  }
}
